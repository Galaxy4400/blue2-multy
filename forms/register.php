		...
		<div class="block-24__body">
			<div class="block-24__column block-24__column_image">
				<div class="block-24__content">
					<h2 class="block-24__title">Sign up</h2>
...
<input type="hidden" name="id" value="su">
					...
					<div class="register-form__section">
						<div class="register-form__row">
							...
							<div class="register-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="password">Password</label>
								</div>
					...
					<div class="register-form__section">
						<div class="register-form__row register-form__row_1">
							<div class="register-form__column">
								<input type="checkbox" name="agreement" value="1" data-check required data-label="I agree to all terms and the privacy policy">
							</div>
						</div>
					</div>
					<div class="register-form__section">
						<div class="register-form__row">
							<div class="register-form__column">
								<button class="help-form__btn btn btn_d btn_fw" type="submit">SIGN UP FOR FREE</button>
							</div>
					...
					<div class="register-form__section register-form__section_last">
						<div class="register-form__row register-form__row_1">
							<div class="register-form__column">
								<p class="register-form__sub-text">Do you already have an account? <a class="register-form__sub-link" href="<?=$language_suffix?>sign-in.php">Enroll</a></p>
							</div>
						</div>
					</div>
				</form>
