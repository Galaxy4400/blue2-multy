...
<input type="hidden" name="id" value="m<?= ++$main_form_counter ?>">
	...
	<div class="form__section">
		<div class="form__row">
			...
			<div class="form__column">
				<div class="form__label-title">
					<label class="form__label" for="first_name">Last name</label>
				</div>
			...
			<div class="form__column">
				<div class="form__label-title">
					<label class="form__label" for="first_name">Phone</label>
				</div>
				<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			</div>
			<div class="form__column">
				<button class="form__btn btn btn_fw" type="submit">SIGN UP FOR FREE</button>
			</div>
...
<div class="main-form__footer">
	<p>By entering your personal information here and pressing the button, you agree to the website's privacy policy and terms and conditions.</p>
</div>