...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">ÎNTREBĂRI FRECVENTE</h2>
<button class="block-21__btn btn btn_d">Continuați la secțiune 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Contacte</h2>
<button class="block-21__btn btn btn_d">Continuați la secțiune</button> 
 </a> 
					</nav>
				</div>
			</section>
