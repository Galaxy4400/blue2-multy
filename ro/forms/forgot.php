		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Parolă uitată</h2>
					<p class="block-25__text">Nu trebuie să vă faceți griji! Introduceți adresa dvs. de e-mail mai jos și vă vom trimite un cod de resetare a parolei.</p>
				</div>
			</div>
