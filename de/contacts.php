					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								...
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="FAQ">Kontakt</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">Kontakt</h1>
					</div>
				</header>
									...
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Email</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>mailto:support@{{domain}}">support@{{domain}}</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Phone</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>+447537131289">+44 753 713 12 89</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Address</dt>
												<dd class="block-13-list__value">175 Piccadilly, St. James's, London W1J 9TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Follow us</dt>
