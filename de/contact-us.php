				...
				<div class="block-21__container _container">
					<nav class="block-21__body">
						<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							...
							<button class="block-21__btn btn btn_d">Weiter zum Abschnitt</button>
						</a>
						<a class="block-21__item" href="<?=$language_suffix?>contacts.php">
							<h2 class="block-21__title">Kontakt</h2>
							<button class="block-21__btn btn btn_d">Weiter zum Abschnitt</button>
						</a>
					</nav>
				</div>
