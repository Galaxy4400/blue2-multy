						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>platform.php">Produkt</a></li>
		...
		<main class="page">
					...
					<div class="block-14__body">
						<div class="block-14__column block-14__column_content">
							<div class="block-14__content">
								<h2 class="block-14__title">Digitale analytik {{site_name}}™</h2>
								<p class="block-14__text">Gewinnen Sie wertvolle Erkenntnisse und fördern Sie Ihr Wachstum mit unseren fortschrittlichen Analysen. Treffen Sie datengestützte Entscheidungen mit Zuversicht. Verfeinern Sie Ihre Strategie und erzielen Sie hervorragende Ergebnisse.</p>
							</div>
						</div>
						<div class="block-14__column block-14__column_actions">
							<div class="block-14__actions block-14-actions">
								<div class="block-14-actions__bottom">
									<a class="block-14-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Anmeldung</a>
								</div>
				...
				<div class="block-15__container _container">
					<div class="block-15__body">
						<div class="block-15__column">
							<h2 class="block-15__title">Digitale Web-Anwendung</h2>
							<div class="block-15__column block-15__column_items">
								<div class="block-15__item block-15-item">
									...
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Kapitalmarkt</h3>
										<p class="block-15-item__label">Alles auf Knopfdruck</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
									...
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Statistiken</h3>
										<p class="block-15-item__label">Genießen Sie alle Daten</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
									...
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Mobile Ansicht</h3>
										<p class="block-15-item__label">Nutzung über Ihr Mobiltelefon</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
									...
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Verwaltung der Kryptowährung</h3>
										<p class="block-15-item__label">Zugang zu jedem Vermögenswert erhalten</p>
									</div>
								</div>
							</div>
						</div>
			...
			<section class="block-16">
				<div class="block-16__container _container">
					<h2 class="block-16__title">{{site_name}} digital merkmale</h2>
					<div class="block-16__body">
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								...
								<p class="block-16-item__text">Hier zeige ich meinen beruflichen Werdegang anhand von beeindruckenden Projekten und kreativen Lösungen.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Kryptowährung kaufen</h4>
								<p class="block-16-item__text">Eine sichere und einfache Plattform zum Kauf von Kryptowährungen. Schnelle Transaktionen, minimale Provisionen. Beginnen Sie jetzt mit dem Handel!</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Krypto-Analytik</h4>
								<p class="block-16-item__text">Erfahren Sie mehr über Marktwerte und Trends, um Investitions und Geschäftsen-tscheidungen treffen zu können.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Krypto-Assets</h4>
								<p class="block-16-item__text">Erforschen Sie die Zukunft der Finanzen mit führenden Kryptowährungen. Entdecken, investieren, wachsen.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="main-form__body">
						<div class="main-form__column main-form__column_image">
							<div class="main-form__content">
								<h2 class="main-form__title">Los geht's!</h2>
								<p class="main-form__text">Tauchen sie ein in die welt der Kryptowährungen! Bereit, in die Welt der Kryptowährung einzutauchen und den Handelsmarkt zu erobern? Mit {{site_name}} erleben Schweizer Trader ein Handelserlebnis, das Innovation, Effizienz  und Gewinnchancen vereint.</p>
							</div>
