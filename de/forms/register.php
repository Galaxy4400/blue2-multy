		...
		<div class="block-24__body">
			<div class="block-24__column block-24__column_image">
				<div class="block-24__content">
					<h2 class="block-24__title">Registrieren Sie sich</h2>
			...
			<div class="block-24__column block-24__column_form">
				<form class="register-form _loading" 
					name="register" 
					method="post" 
					action="reg/send.php" 
					data-form 
				...
				>
						...
						<div class="register-form__row">
							<div class="register-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="first_name">Vornamame</label> 
								</div>
								<input class="register-form__input input" type="text" id="first_name" name="first_name" required>
							</div>
							<div class="register-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="last_name">Nachname</label> 
								</div>
							...
							<div class="register-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="password">Passwort</label> 
								</div>
					...
					<div class="register-form__section register-form__section_last">
						<div class="register-form__row register-form__row_1">
							<div class="register-form__column">
								<p class="register-form__sub-text">Sie haben bereits ein Konto? <a class="register-form__sub-link" href="<?=$language_suffix?>sign-in.php">Eintragen</a></p>
							</div>
						</div>
					</div>
				</form>
