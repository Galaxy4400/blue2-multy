		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Wie können wir helfen?</h2>
				...
				>
					<div class="help-form__section">
						<div class="help-form__row">
							<div class="help-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="name">Name</label> 
								</div>
						...
						<div class="help-form__row help-form__row_1">
							<div class="help-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="message">Beschreiben Sie das Problem</label> 
								</div>
								<textarea class="help-form__input input" id="message" name="message" required></textarea>
							</div>
						</div>
						<!-- <div class="help-form__row help-form__row_1">
							<div class="help-form__column">
					...
					<div class="help-form__section">
						<div class="help-form__row">
							<div class="help-form__column">
								<button class="help-form__btn btn btn_d btn_fw" type="submit">Anmeldung</button>
							</div>
							<div class="form__column form-message">
							</div>
						</div>
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Indem Sie hier Ihre persönlichen Informationen eingeben und die Schaltfläche drücken, erklären Sie sich mit der Datenschutzrichtlinie und den Allgemeinen Geschäftsbedingungen der Website einverstanden.</p>
						</div>
					</div>
				</form>
			</div>
