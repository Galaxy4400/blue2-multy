		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Bei Ihrem Konto anmelden</h2>
			...
			<div class="block-25__column block-25__column_form">
				<form class="signin-form" 
					...
					data-send="test"
					data-validation 
					data-after="signinFormAfterSubmit"
				...
				>
						...
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
								<div class="help-form__label-title">
									<label class="help-form__label" for="email">Name</label> 
								</div>
							...
							<div class="signin-form__column">
								...
								<div class="signin-form__link-block">
									<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">Ihr Passwort vergessen?</a>
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
								<button class="help-form__btn btn btn_d btn_fw" type="submit">Eintragen</button>
								<p class="signin-form__sub-text">Kein Konto? <a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">Registrieren Sie sich.</a></p>
							</div>
