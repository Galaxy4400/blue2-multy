		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Unustatud parool</h2>
					<p class="block-25__text">Pole vaja muretseda! Sisestage allpool oma e-posti aadress ja me saadame teile parooli lähtestamise koodi.</p>
				</div>
			</div>
