		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Zapomniane hasło</h2>
					<p class="block-25__text">Nie musisz się martwić! Wpisz swój adres e-mail poniżej, a my wyślemy Ci kod resetowania hasła.</p>
				</div>
			</div>
