...
<label class="form__label" for="first_name">Imię</label> 
				</div>
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Nazwisko</label> 
				</div>
...
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			...
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">ZAREJESTRUJ SIĘ ZA DARMO</button> 
			</div>
...
<div class="main-form__footer">
	<p>Wprowadzając tutaj swoje dane osobowe i naciskając przycisk, wyrażasz zgodę na politykę prywatności i warunki korzystania z witryny.</p>
</div>