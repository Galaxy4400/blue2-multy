						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>benefits.php">Avantages</a></li>
		...
		<main class="page">
					...
					<div class="block-17__body">
						<div class="block-17__column block-17__column_content">
							<div class="block-17__content">
								<h2 class="block-17__title">Téléchargez Portfolio Tracker</h2>
								<p class="block-17__text">Débloquez rapidement le trading : inscrivez-vous, effectuez un dépôt et commencez votre voyage en seulement 5 minutes. Plongez dès maintenant !</p>
							</div>
						</div>
						<div class="block-17__column block-17__column_actions">
							<div class="block-17__actions block-17-actions">
								<div class="block-17-actions__bottom">
									<a class="block-17-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">S&#39;inscrire</a>
								</div>
			...
			<section class="block-18">
				<div class="block-18__container _container">
					<h2 class="block-18__title">Comment ça marche</h2>
					<div class="block-18__body">
						<div class="block-18__item">
							<h3 class="block-18__item-title">Créez un compte</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Rechargez votre compte</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Commencez à acheter et à vendre</h3>
						</div>
					</div>
				</div>
			</section>
