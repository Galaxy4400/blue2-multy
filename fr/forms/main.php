...
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			...
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Nom de famille</label> 
				</div>
<input class="form__input input" type="text" id="last_name" name="last_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Courrier électronique</label> 
				</div>
<input class="form__input input" type="email" id="email" name="email" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Téléphone</label> 
				</div>
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			</div>
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">INSCRIVEZ-VOUS GRATUITEMENT</button> 
			</div>
...
<div class="main-form__footer">
	<p>En saisissant vos informations personnelles ici et en appuyant sur le bouton, vous acceptez la politique de confidentialité et les conditions générales du site Web.</p>
</div>