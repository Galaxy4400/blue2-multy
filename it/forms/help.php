		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Come possiamo aiutarti?</h2>
...
<label class="help-form__label" for="name">Nome</label> 
								</div>
...
<input class="help-form__input input" id="email" type="email" name="email" required>
						...
						<div class="help-form__row help-form__row_1">
							<div class="help-form__column">
								<div class="help-form__label-title">
<label class="help-form__label" for="message">Descrivi il problema</label> 
								</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Inviare</button> 
						...
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Inserendo qui le tue informazioni personali e premendo il pulsante, accetti l&#39;informativa sulla privacy e i termini e le condizioni del sito web.</p>
						</div>
					</div>
				</form>
			</div>
