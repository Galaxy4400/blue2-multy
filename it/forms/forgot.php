		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Password dimenticata</h2>
					<p class="block-25__text">Non c&#39;è bisogno di preoccuparsi! Inserisci la tua email qui sotto e ti invieremo un codice per reimpostare la password.</p>
				</div>
			</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Inviare</button> 
							</div>
