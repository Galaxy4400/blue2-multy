		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Accedi al tuo account</h2>
...
<label class="help-form__label" for="email">Nome</label> 
								</div>
...
<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">Password dimenticata?</a> 
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">Effettua il login</button> 
								<p class="signin-form__sub-text">Nessun account? <a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">Registrati</a></p>
							</div>
