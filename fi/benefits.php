						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>benefits.php">Hyödyt</a></li>
		...
		<main class="page">
					...
					<div class="block-17__body">
						<div class="block-17__column block-17__column_content">
							<div class="block-17__content">
								<h2 class="block-17__title">Hanki Portfolio Tracker</h2>
								<p class="block-17__text">Avaa kaupankäynti nopeasti: Rekisteröidy, talleta ja aloita matkasi vain 5 minuutissa. Sukella sisään nyt!</p>
							</div>
						</div>
						<div class="block-17__column block-17__column_actions">
							<div class="block-17__actions block-17-actions">
								<div class="block-17-actions__bottom">
									<a class="block-17-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Rekisteröidy</a>
								</div>
								<div class="block-17-actions__top">
									...
									<div class="block-17-actions__column">
										<a class="block-17-actions__btn block-17-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/app-store.svg" alt="Sovelluskauppa"></a>
									</div>
								</div>
							</div>
							<figure class="block-17__image-2">
								<img src="<?=$dir_prefix?>assets/img/deco/8.webp" alt="kuva">
							</figure>
						</div>
						<figure class="block-17__image-1" data-adapt="block-17__column_actions,991">
							<img src="<?=$dir_prefix?>assets/img/deco/9.webp" alt="kuva">
						</figure>
					</div>
				</div>
			</section>
			...
			<section class="block-18">
				<div class="block-18__container _container">
					<h2 class="block-18__title">Miten se toimii</h2>
					<div class="block-18__body">
						<div class="block-18__item">
							<h3 class="block-18__item-title">Luo tili</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Täydennä tiliäsi</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Aloita ostaminen ja myynti</h3>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="main-form__body">
						<div class="main-form__column main-form__column_image">
							<div class="main-form__content">
								<h2 class="main-form__title">Tämä on kauppaa {{site_name}} kanssa™</h2>
