		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Miten voimme auttaa?</h2>
...
<input class="help-form__input input" id="email" type="email" name="email" required>
						...
						<div class="help-form__row help-form__row_1">
							<div class="help-form__column">
								<div class="help-form__label-title">
<label class="help-form__label" for="message">Kuvaile ongelmaa</label> 
								</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Lähetä</button> 
						...
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Syöttämällä henkilökohtaiset tietosi tähän ja painamalla painiketta, hyväksyt verkkosivuston tietosuojakäytännön ja ehdot.</p>
						</div>
					</div>
				</form>
			</div>
