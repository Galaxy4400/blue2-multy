		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Unohtunut salasana</h2>
					<p class="block-25__text">Ei tarvitse huolehtia! Kirjoita sähköpostiosoitteesi alle, niin lähetämme sinulle salasanan palautuskoodin.</p>
				</div>
			</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Lähetä</button> 
							</div>
