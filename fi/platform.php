						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>platform.php">Alusta</a></li>
		...
		<main class="page">
					...
					<div class="block-14__body">
						<div class="block-14__column block-14__column_content">
							<div class="block-14__content">
								<h2 class="block-14__title">Digitaalinen analytiikka {{site_name}}™</h2>
								<p class="block-14__text">Hanki arvokkaita oivalluksia ja edistä kasvua edistyneiden analytiikkamme avulla. Tee tietopohjaisia päätöksiä luottavaisin mielin. Tarkenna strategiaasi ja saat hyviä tuloksia.</p>
							</div>
						</div>
						<div class="block-14__column block-14__column_actions">
							<div class="block-14__actions block-14-actions">
								<div class="block-14-actions__bottom">
									<a class="block-14-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Rekisteröidy</a>
								</div>
								<div class="block-14-actions__top">
									...
									<div class="block-14-actions__column">
										<a class="block-14-actions__btn block-14-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/app-store.svg" alt="Sovelluskauppa"></a>
									</div>
								</div>
							</div>
							<figure class="block-14__image">
								<img src="<?=$dir_prefix?>assets/img/deco/5.webp" alt="kuva">
							</figure>
						</div>
					</div>
				</div>
				...
				<div class="block-15__container _container">
					<div class="block-15__body">
						<div class="block-15__column">
							<h2 class="block-15__title">Digitaalinen verkkosovellus</h2>
							<div class="block-15__column block-15__column_items">
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
										<img src="<?=$dir_prefix?>assets/img/digits/1.svg" alt="kuva">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Pääomamarkkinat</h3>
										<p class="block-15-item__label">Kaikki napin painalluksella</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
										<img src="<?=$dir_prefix?>assets/img/digits/2.svg" alt="kuva">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Tilastot</h3>
										<p class="block-15-item__label">Nauti kaikista tiedoista</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
										<img src="<?=$dir_prefix?>assets/img/digits/3.svg" alt="kuva">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Mobiilinäkymä</h3>
										<p class="block-15-item__label">Käytä matkapuhelimesi kautta</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
										<img src="<?=$dir_prefix?>assets/img/digits/4.svg" alt="kuva">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Kryptovaluutan hallinta</h3>
										<p class="block-15-item__label">Pääset käsiksi kaikkiin resursseihin</p>
									</div>
								</div>
							</div>
						</div>
			...
			<section class="block-16">
				<div class="block-16__container _container">
					<h2 class="block-16__title">{{site_name}} digitaaliset ominaisuudet</h2>
					<div class="block-16__body">
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Salkku</h4>
								<p class="block-16-item__text">Tässä näytän ammatillisen urani vaikuttavien projektien ja luovien ratkaisujen perusteella.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Osta kryptovaluutta</h4>
								<p class="block-16-item__text">Turvallinen ja helppo alusta kryptovaluuttojen ostamiseen. Nopeat tapahtumat, minimaaliset palkkiot. Aloita kaupankäynti nyt!</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Kryptoanalytiikka</h4>
								<p class="block-16-item__text">Lue lisää markkina-arvoista ja trendeistä, jotta voit tehdä sijoitus- ja liiketoimintapäätöksiä.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Kryptovarat</h4>
								<p class="block-16-item__text">Tutustu rahoituksen tulevaisuuteen johtavien kryptovaluuttojen avulla. Löydä, sijoita, kasva.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="main-form__body">
						<div class="main-form__column main-form__column_image">
							<div class="main-form__content">
								<h2 class="main-form__title">Mennään!</h2>
								<p class="main-form__text">Sukella kryptovaluuttojen maailmaan! Oletko valmis sukeltamaan kryptovaluuttamaailmaan ja valloittamaan kaupankäyntimarkkinat? {{site_name}} avulla sveitsiläiset kauppiaat kokevat kaupankäyntikokemuksen, jossa yhdistyvät innovaatio, tehokkuus ja voittomahdollisuudet.</p>
							</div>
