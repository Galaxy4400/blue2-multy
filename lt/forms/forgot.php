		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Pamiršote slaptažodį</h2>
					<p class="block-25__text">Nereikia jaudintis! Įveskite savo el. paštą žemiau ir mes atsiųsime jums slaptažodžio nustatymo kodą.</p>
				</div>
			</div>
