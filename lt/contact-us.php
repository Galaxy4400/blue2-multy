...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">DUK</h2>
<button class="block-21__btn btn btn_d">Pereikite prie skyriaus 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Kontaktai</h2>
<button class="block-21__btn btn btn_d">Pereikite prie skyriaus</button> 
 </a> 
					</nav>
				</div>
			</section>
