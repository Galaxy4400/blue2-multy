		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Zabudnuté heslo</h2>
					<p class="block-25__text">Nemusíte sa báť! Zadajte svoj e-mail nižšie a my vám pošleme kód na obnovenie hesla.</p>
				</div>
			</div>
