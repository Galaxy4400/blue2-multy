						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>our-team.php">Náš tím</a></li>
					...
					<div class="block-19__body">
						<div class="block-19__column block-19__column_left">
							<div class="block-19__main">
								<h2 class="block-19__title">Poslanie, vízia a hodnoty</h2>
								<div class="block-19__footer">
									<figure class="block-19__image">
<img src="<?=$dir_prefix?>assets/img/deco/10.webp" alt="imidž">
									</figure>
								</div>
							</div>
						</div>
...
<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imidž">
									</figure>
									<h3 class="block-19-item__title">P.o</h3>
									<p class="block-19-item__text">Posilnenie spoločenstiev prostredníctvom vzdelávania, inovácií a udržateľných postupov pre jasnejšiu a spravodlivejšiu budúcnosť.</p>
								</div>
								<div class="block-19__item block-19-item">
									<figure class="block-19-item__image">
<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imidž">
									</figure>
									<h3 class="block-19-item__title">Vízia</h3>
									<p class="block-19-item__text">Podpora integrity, inovácie a inkluzívnosti pre pozitívnejšiu a udržateľnejšiu globálnu komunitu.</p>
								</div>
								<div class="block-19__item block-19-item">
									<figure class="block-19-item__image">
<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imidž">
									...
									<p class="block-19-item__text">Podpora sveta, v ktorom tvorivosť a inovácie poháňajú pozitívnu zmenu a začlenenie.</p>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="block-20">
				<div class="block-20__container _container">
					<h2 class="block-20__title title-h2">Náš manažérsky tím</h2>
					<div class="block-20__body">
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
<img src="<?=$dir_prefix?>assets/img/people/1.webp" alt="Ľudia">
							</figure>
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Pán Anderson</h4>
								<p class="block-20-item__text">Spoluzakladateľ</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
<img src="<?=$dir_prefix?>assets/img/people/2.webp" alt="Ľudia">
							</figure>
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Adam Levine</h4>
								<p class="block-20-item__text">Manažér závodu</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
<img src="<?=$dir_prefix?>assets/img/people/3.webp" alt="Ľudia">
							</figure>
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Mike Leto</h4>
								<p class="block-20-item__text">Produktový manažér</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
<img src="<?=$dir_prefix?>assets/img/people/4.webp" alt="osoba">
							...
							<div class="block-20-item__content">
								...
								<p class="block-20-item__text">Finančný úradník</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
<img src="<?=$dir_prefix?>assets/img/people/5.webp" alt="osoba">
							...
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Regína</h4>
