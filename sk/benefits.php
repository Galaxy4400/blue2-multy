					...
					<div class="block-17__body">
						<div class="block-17__column block-17__column_content">
							<div class="block-17__content">
								<h2 class="block-17__title">Získajte sledovač portfólia</h2>
								<p class="block-17__text">Rýchlo odomknite obchodovanie: Zaregistrujte sa, vložte vklad a začnite svoju cestu za 5 minút. Ponorte sa teraz!</p>
							</div>
						</div>
...
<a class="block-17-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Registrovať</a> 
								</div>
...
<a class="block-17-actions__btn block-17-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/google-pay.svg" alt="Google Pay"></a>
									...
									<div class="block-17-actions__column">
<a class="block-17-actions__btn block-17-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/app-store.svg" alt="Obchod s aplikáciami"></a>
									</div>
								</div>
							</div>
							<figure class="block-17__image-2">
<img src="<?=$dir_prefix?>assets/img/deco/8.webp" alt="imidž">
							</figure>
						</div>
						<figure class="block-17__image-1" data-adapt="block-17__column_actions,991">
<img src="<?=$dir_prefix?>assets/img/deco/9.webp" alt="imidž">
						</figure>
					</div>
				</div>
			</section>
			...
			<section class="block-18">
				<div class="block-18__container _container">
					<h2 class="block-18__title">Ako to funguje</h2>
					<div class="block-18__body">
						<div class="block-18__item">
							<h3 class="block-18__item-title">Vytvoriť účet</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Doplňte svoj účet</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Začnite nakupovať a predávať</h3>
						</div>
					</div>
				</div>
			</section>
