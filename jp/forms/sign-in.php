		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">アカウントにサインイン</h2>
...
<label class="help-form__label" for="email">[名前]</label> 
								</div>
...
<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">パスワードをお忘れですか？</a>
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">サインイン</button> 
								<p class="signin-form__sub-text">アカウントはありませんか？<a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">サインアップ。</a></p>
							</div>
