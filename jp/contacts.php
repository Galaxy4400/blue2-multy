					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								...
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="よくある質問">連絡先</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">連絡先</h1>
					</div>
				</header>
							...
							<div class="block-23__body">
									...
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">E メール</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>mailto:support@{{domain}}">support@{{domain}}</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">電話</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>+447537131289">+44 753 713 12 89</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">アドレス</dt>
												<dd class="block-13-list__value">175 ピカデリー、セントジェームズ、ロンドン W1J 9TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">フォローしてください</dt>
												<dd class="block-13-list__value">
													<ul class="block-13-list__links block-13-list-links">
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">インスタグラム</a></li>
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">フェイスブック</a></li>
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">トレーディングビュー</a></li>
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">テレグラム</a></li>
													</ul>
												</dd>
											</div>
										</dl>
								...
								<div class="block-23__column block-23__column_image">
									<figure class="block-23__image _ibg">
										<img src="<?=$dir_prefix?>assets/img/deco/12.webp" alt="デコ">
									</figure>
								</div>
							</div>
						</div>
