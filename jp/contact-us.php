				...
				<div class="block-21__container _container">
					<nav class="block-21__body">
						<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">よくある質問</h2>
							<button class="block-21__btn btn btn_d">セクションに進む
							...
							<h2 class="block-21__title">連絡先</h2>
							<button class="block-21__btn btn btn_d">セクションに進む</button>
						</a>
					</nav>
				</div>
			</section>
