...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">GYIK</h2>
<button class="block-21__btn btn btn_d">Folytassa a szakaszhoz 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Kapcsolatok</h2>
<button class="block-21__btn btn btn_d">Folytassa a szakaszhoz</button> 
 </a> 
					</nav>
				</div>
			</section>
