...
<label class="form__label" for="first_name">Keresztnév</label> 
				</div>
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Vezetéknév</label> 
				</div>
...
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			...
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">REGISZTRÁLJON INGYEN</button> 
			</div>
...
<div class="main-form__footer">
	<p>Személyes adatainak megadásával és a gomb megnyomásával Ön elfogadja a weboldal adatvédelmi irányelveit és feltételeit.</p>
</div>