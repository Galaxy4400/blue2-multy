		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Jelentkezzen be fiókjába</h2>
...
<label class="help-form__label" for="email">Név</label> 
								</div>
<input class="signin-form__input input" type="email" id="email" name="email" required>
							</div>
							<div class="signin-form__column">
								<div class="help-form__label-title">
<label class="help-form__label" for="password">Jelszó</label> 
								</div>
...
<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">Elfelejtette a jelszavát?</a> 
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">Bejelentkezés</button> 
								<p class="signin-form__sub-text">Nincs számla? <a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">Iratkozzon fel.</a></p>
							</div>
