		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Elfelejtett jelszó</h2>
					<p class="block-25__text">Nem kell aggódnia! Írja be alább e-mail címét, és elküldünk egy jelszó-visszaállítási kódot.</p>
				</div>
			</div>
