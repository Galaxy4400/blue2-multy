					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								...
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="GYIK">Kapcsolatok</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">Kapcsolatok</h1>
					</div>
				</header>
									...
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											<div class="block-13-list__item">
												...
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>mailto:support@{{domain}}">támogatás@ {{domain}}</a></dd>
											</div>
											<div class="block-13-list__item">
											...
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Cím</dt>
												<dd class="block-13-list__value">175 Piccadilly, St. Jakab, London W1J 9TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Kövess minket</dt>
												<dd class="block-13-list__value">
													<ul class="block-13-list__links block-13-list-links">
														...
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">Távirat</a></li>
													</ul>
												</dd>
											</div>
										</dl>
