		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Hur kan vi hjälpa till?</h2>
...
<label class="help-form__label" for="name">Namn</label> 
								</div>
...
<textarea class="help-form__input input" id="message" name="message" required>
					...
					<div class="help-form__section">
						<div class="help-form__row">
							<div class="help-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">Sänd</button> 
							</div>
							<div class="form__column form-message">
							</div>
						</div>
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Genom att ange din personliga information här och trycka på knappen godkänner du webbplatsens sekretesspolicy och villkor.</p>
						</div>
					</div>
				</form>
			</div>
