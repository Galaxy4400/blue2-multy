		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Glömt lösenord</h2>
					<p class="block-25__text">Du behöver inte oroa dig! Ange din e-postadress nedan så skickar vi dig en lösenordsåterställningskod.</p>
				</div>
			</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Skicka</button> 
							</div>
