					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								...
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="FAQ">Kontakty</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">Kontakty</h1>
					</div>
				</header>
									...
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">E-mailem</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>mailto:support@{{domain}}">support@ {{doména}}</a></dd>
											</div>
											<div class="block-13-list__item">
											...
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Adresa</dt>
												<dd class="block-13-list__value">175 Piccadilly, St. James&#39;s, Londýn W1J 9TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Následuj nás</dt>
												<dd class="block-13-list__value">
													<ul class="block-13-list__links block-13-list-links">
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">Instagramu</a></li>
