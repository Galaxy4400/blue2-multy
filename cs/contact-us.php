...
<button class="block-21__btn btn btn_d">Pokračujte do sekce 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Kontakty</h2>
<button class="block-21__btn btn btn_d">Pokračujte do sekce</button> 
 </a> 
					</nav>
				</div>
			</section>
