						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>platform.php">Nástupiště</a></li>
					...
					<div class="block-14__body">
						<div class="block-14__column block-14__column_content">
							<div class="block-14__content">
								<h2 class="block-14__title">Digitální analytika {{site_name}}™</h2>
								<p class="block-14__text">Získejte cenné poznatky a podpořte růst pomocí našich pokročilých analýz. Dělejte rozhodnutí založená na datech s důvěrou. Upřesněte svou strategii a získejte skvělé výsledky.</p>
							</div>
						</div>
...
<a class="block-14-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Registrovat</a> 
								</div>
								<div class="block-14-actions__top">
									<div class="block-14-actions__column">
<a class="block-14-actions__btn block-14-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/google-pay.svg" alt="Služba Google Pay"></a>
									</div>
									<div class="block-14-actions__column">
<a class="block-14-actions__btn block-14-actions__btn_img btn btn_d btn_fw" href="<?=$language_suffix?>benefits.php"><img src="<?=$dir_prefix?>assets/img/app-store.svg" alt="Obchod s aplikacemi"></a>
									</div>
								</div>
							</div>
							<figure class="block-14__image">
<img src="<?=$dir_prefix?>assets/img/deco/5.webp" alt="obraz">
							</figure>
						</div>
					</div>
				</div>
				...
				<div class="block-15__container _container">
					<div class="block-15__body">
						<div class="block-15__column">
							<h2 class="block-15__title">Digitální webová aplikace</h2>
							<div class="block-15__column block-15__column_items">
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
<img src="<?=$dir_prefix?>assets/img/digits/1.svg" alt="obraz">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Kapitálový trh</h3>
										<p class="block-15-item__label">Vše pouhým stisknutím tlačítka</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
<img src="<?=$dir_prefix?>assets/img/digits/2.svg" alt="obraz">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Statistika</h3>
										<p class="block-15-item__label">Užijte si všechna data</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
<img src="<?=$dir_prefix?>assets/img/digits/3.svg" alt="obraz">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Mobilní zobrazení</h3>
										<p class="block-15-item__label">Používejte prostřednictvím mobilního telefonu</p>
									</div>
								</div>
								<div class="block-15__item block-15-item">
									<figure class="block-15-item__image">
<img src="<?=$dir_prefix?>assets/img/digits/4.svg" alt="obraz">
									</figure>
									<div class="block-15-item__content">
										<h3 class="block-15-item__title">Správa kryptoměn</h3>
										<p class="block-15-item__label">Získejte přístup ke všem aktivům</p>
									</div>
								</div>
							</div>
						</div>
...
<img src="<?=$dir_prefix?>assets/img/deco/7.webp" alt="Deco">
			...
			<section class="block-16">
				<div class="block-16__container _container">
					<h2 class="block-16__title">{{site_name}} digitální funkce</h2>
					<div class="block-16__body">
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								...
								<p class="block-16-item__text">Zde ukazuji svou profesionální kariéru založenou na působivých projektech a kreativních řešeních.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Koupit kryptoměnu</h4>
								<p class="block-16-item__text">Bezpečná a snadná platforma pro nákup kryptoměn. Rychlé transakce, minimální provize. Začněte obchodovat hned teď!</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Kryptoanalytika</h4>
								<p class="block-16-item__text">Zjistěte více o tržních hodnotách a trendech, abyste mohli činit investiční a obchodní rozhodnutí.</p>
							</div>
						</div>
						<div class="block-16__item block-16-item">
							<div class="block-16-item__content">
								<h4 class="block-16-item__title">Kryptoaktiva</h4>
								<p class="block-16-item__text">Prozkoumejte budoucnost financí s předními kryptoměnami. Objevujte, investujte, rostete.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="main-form__body">
						<div class="main-form__column main-form__column_image">
							<div class="main-form__content">
								<h2 class="main-form__title">Pojďme!</h2>
								<p class="main-form__text">Ponořte se do světa kryptoměn! Jste připraveni ponořit se do světa kryptoměn a dobýt obchodní trh? S {{site_name}} švýcarští obchodníci zažijí obchodní zkušenost, která kombinuje inovace, efektivitu a příležitosti k zisku.</p>
							</div>
