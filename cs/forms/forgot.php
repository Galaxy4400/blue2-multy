		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Zapomenuté heslo</h2>
					<p class="block-25__text">Není třeba se obávat! Níže zadejte svůj e-mail a my vám zašleme kód pro obnovení hesla.</p>
				</div>
			</div>
