...
<label class="form__label" for="first_name">Křestní jméno</label> 
				</div>
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Příjmení</label> 
				</div>
<input class="form__input input" type="text" id="last_name" name="last_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">E-mailem</label> 
				</div>
...
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			...
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">ZAREGISTRUJTE SE ZDARMA</button> 
			</div>
...
<div class="main-form__footer">
	<p>Zadáním svých osobních údajů zde a stisknutím tlačítka, souhlasíte se zásadami ochrany osobních údajů a podmínkami webu.</p>
</div>