				...
				<div class="block-21__container _container">
					<nav class="block-21__body">
						<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">PREGUNTAS MÁS FRECUENTES</h2>
							<button class="block-21__btn btn btn_d">Continúe con la sección
							...
							<h2 class="block-21__title">Contactos</h2>
							<button class="block-21__btn btn btn_d">Continúe con la sección</button>
						</a>
					</nav>
				</div>
			</section>
