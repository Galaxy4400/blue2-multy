						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>our-team.php">¿Nuestro equipo</a></li>
		...
		<main class="page">
					...
					<div class="block-19__body">
						<div class="block-19__column block-19__column_left">
							<div class="block-19__main">
								<h2 class="block-19__title">Misión, visión y valores</h2>
								<div class="block-19__footer">
									<figure class="block-19__image">
										<img src="<?=$dir_prefix?>assets/img/deco/10.webp" alt="imagen">
									</figure>
								</div>
							</div>
						</div>
							...
							<div class="block-19__content">
								<div class="block-19__item block-19-item">
									<figure class="block-19-item__image">
										<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imagen">
									</figure>
									<h3 class="block-19-item__title">P.o</h3>
									<p class="block-19-item__text">Empoderar a las comunidades a través de la educación, la innovación y las prácticas sostenibles para un futuro más brillante y equitativo.</p>
								</div>
								<div class="block-19__item block-19-item">
									<figure class="block-19-item__image">
										<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imagen">
									</figure>
									<h3 class="block-19-item__title">Visión</h3>
									<p class="block-19-item__text">Fomentar la integridad, la innovación y la inclusión para una comunidad global más positiva y sostenible.</p>
								</div>
								<div class="block-19__item block-19-item">
									<figure class="block-19-item__image">
										<img src="<?=$dir_prefix?>assets/img/team/1.svg" alt="imagen">
									...
									<p class="block-19-item__text">Fomentar un mundo en el que la creatividad y la innovación impulsen el cambio positivo y la inclusión.</p>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="block-20">
				<div class="block-20__container _container">
					<h2 class="block-20__title title-h2">Nuestro equipo de gestión</h2>
					<div class="block-20__body">
						...
						<div class="block-20__item block-20-item">
							...
							<div class="block-20-item__content">
								...
								<p class="block-20-item__text">Gerente de planta</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
								<img src="<?=$dir_prefix?>assets/img/people/3.webp" alt="Persona">
							</figure>
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Mike Leto</h4>
								<p class="block-20-item__text">Gerente de producto</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
							...
							<div class="block-20-item__content">
								...
								<p class="block-20-item__text">Oficial de finanzas</p>
							</div>
						</div>
						<div class="block-20__item block-20-item">
							<figure class="block-20-item__image">
						...
						<div class="block-20__item block-20-item">
							...
							<div class="block-20-item__content">
								<h4 class="block-20-item__title">Joe Armstrong</h4>
								<p class="block-20-item__text">Técnica</p>
							</div>
						</div>
					</div>
					...
					<div class="partners__slider partners-slider" data-swiper>
						<div class="partners-slider__slides">
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/1.svg" alt="¿Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/2.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/3.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/4.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/5.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/6.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/7.svg" alt="Socio">
							</div>
							<div class="partners-slider__slide">
								<img src="<?=$dir_prefix?>assets/img/partners/8.svg" alt="Socio">
							</div>
						</div>
					</div>
				</div>
