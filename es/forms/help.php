		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">¿Cómo podemos ayudar?</h2>
...
<label class="help-form__label" for="name">Nombre</label> 
								</div>
...
<input class="help-form__input input" id="email" type="email" name="email" required>
						...
						<div class="help-form__row help-form__row_1">
							<div class="help-form__column">
								<div class="help-form__label-title">
<label class="help-form__label" for="message">Describe el problema</label> 
								</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Enviar</button> 
						...
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Al introducir tu información personal aquí y pulsar el botón, aceptas la política de privacidad y los términos y condiciones del sitio web.</p>
						</div>
					</div>
				</form>
			</div>
