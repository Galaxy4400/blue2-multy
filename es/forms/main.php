...
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			...
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Apellidos</label> 
				</div>
<input class="form__input input" type="text" id="last_name" name="last_name" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Correo electrónico</label> 
				</div>
<input class="form__input input" type="email" id="email" name="email" required>
			</div>
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Teléfono</label> 
				</div>
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			</div>
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">REGÍSTRATE GRATIS</button> 
			</div>
...
<div class="main-form__footer">
	<p>Al introducir tu información personal aquí y pulsar el botón, aceptas la política de privacidad y los términos y condiciones del sitio web.</p>
</div>