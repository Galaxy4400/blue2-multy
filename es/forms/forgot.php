		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Contraseña olvidada</h2>
					<p class="block-25__text">¡No hay de qué preocuparse! Introduce tu correo electrónico a continuación y te enviaremos un código para restablecer la contraseña.</p>
				</div>
			</div>
			<div class="block-25__column block-25__column_form">
				<form class="forgot-form" name="forgot" action="./" method="post" data-form data-send="test" data-validation data-after="forgotFormAfterSubmit" data-autocomplete-off>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Enviar</button> 
							</div>
