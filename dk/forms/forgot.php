		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Glemt adgangskode</h2>
					<p class="block-25__text">Ingen grund til at bekymre dig! Indtast din e-mail nedenfor, så sender vi dig en kode til nulstilling af adgangskode.</p>
				</div>
			</div>
