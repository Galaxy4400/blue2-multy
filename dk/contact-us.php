				...
				<div class="block-21__container _container">
					<nav class="block-21__body">
						<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">OFTE STILLEDE SPØRGSMÅL</h2>
							<button class="block-21__btn btn btn_d">Fortsæt til afsnittet
							...
							<button class="block-21__btn btn btn_d">Fortsæt til afsnittet</button>
						</a>
					</nav>
				</div>
			</section>
