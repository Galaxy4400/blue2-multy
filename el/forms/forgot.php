		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Ξεχάσατε τον κωδικό</h2>
					<p class="block-25__text">Δεν χρειάζεται να ανησυχείτε! Εισαγάγετε το email σας παρακάτω και θα σας στείλουμε έναν κωδικό επαναφοράς κωδικού πρόσβασης.</p>
				</div>
			</div>
