...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">ΣΥΧΝΈΣ ΕΡΩΤΉΣΕΙΣ</h2>
<button class="block-21__btn btn btn_d">Προχωρήστε στην ενότητα 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Επαφές</h2>
<button class="block-21__btn btn btn_d">Προχωρήστε στην ενότητα</button> 
 </a> 
					</nav>
				</div>
			</section>
