...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">PERGUNTAS FREQUENTES</h2>
<button class="block-21__btn btn btn_d">Prossiga para a seção 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Contatos</h2>
<button class="block-21__btn btn btn_d">Prossiga para a seção</button> 
 </a> 
					</nav>
				</div>
			</section>
