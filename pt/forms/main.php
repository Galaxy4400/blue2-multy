...
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			...
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Último nome</label> 
				</div>
...
<input class="form__input input" type="email" id="email" name="email" required>
			...
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Telefone</label> 
				</div>
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			</div>
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">INSCREVA-SE GRATUITAMENTE</button> 
			</div>
...
<div class="main-form__footer">
	<p>Ao inserir suas informações pessoais aqui e pressionar o botão, você concorda com a política de privacidade e os termos e condições do site.</p>
</div>