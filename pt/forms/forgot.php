		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Senha esquecida</h2>
					<p class="block-25__text">Não precisa se preocupar! Digite seu e-mail abaixo e enviaremos um código de redefinição de senha.</p>
				</div>
			</div>
