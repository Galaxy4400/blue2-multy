...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">자주 묻는 질문</h2>
<button class="block-21__btn btn btn_d">섹션으로 이동 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">연락처</h2>
<button class="block-21__btn btn btn_d">섹션으로 이동</button> 
 </a> 
					</nav>
				</div>
			</section>
