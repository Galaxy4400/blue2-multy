		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">계정에 로그인</h2>
...
<label class="help-form__label" for="email">이름</label> 
								</div>
...
<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">비밀번호를 잊으셨나요?</a>
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">로그인</button> 
								<p class="signin-form__sub-text">계정이 없으세요?<a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">가입하세요.</a></p>
							</div>
