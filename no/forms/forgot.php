		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Glemt passord</h2>
					<p class="block-25__text">Du trenger ikke å bekymre deg! Skriv inn e-postadressen din nedenfor, så sender vi deg en kode for tilbakestilling av passord.</p>
				</div>
			</div>
