...
<input class="form__input input" type="text" id="first_name" name="first_name" required>
			...
			<div class="form__column">
				<div class="form__label-title">
<label class="form__label" for="first_name">Etternavn</label> 
				</div>
...
<input class="form__input input" type="tel" id="phone" name="phone" data-phone>
			...
			<div class="form__column">
<button class="form__btn btn btn_fw" type="submit">REGISTRER DEG GRATIS</button> 
			</div>
...
<div class="main-form__footer">
	<p>Ved å skrive inn din personlige informasjon her og trykke på knappen, godtar du nettstedets personvernregler og vilkår og betingelser.</p>
</div>