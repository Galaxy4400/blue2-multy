		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Hvordan kan vi hjelpe?</h2>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Sende</button> 
						...
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Ved å skrive inn din personlige informasjon her og trykke på knappen, godtar du nettstedets personvernregler og vilkår og betingelser.</p>
						</div>
					</div>
				</form>
			</div>
