						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>contact-us.php">Kontakt oss</a></li>
								</ul>
							</nav>
						</div>
					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								<li class="breadcrumbs__item"><a class="breadcrumbs__link" href="<?=$language_suffix?>contact-us.php" title="Kontakt oss">Kontakt oss</a></li>
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="FAQ">Kontakter</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">Kontakter</h1>
					</div>
				</header>
								...
								<div class="block-23__column block-23__column_table">
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											...
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Telefonen</dt>
											...
											<div class="block-13-list__item">
												...
												<dd class="block-13-list__value">175 Piccadilly, St. James&#39;s, London W1J 9 TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Følg oss</dt>
