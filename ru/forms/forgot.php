		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Забытый пароль</h2>
					<p class="block-25__text">Не нужно беспокоиться! Введите свой адрес электронной почты ниже, и мы вышлем вам код для восстановления пароля.</p>
				</div>
			</div>
