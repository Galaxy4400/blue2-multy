					...
					<div class="inner-header__container _container">
						<nav class="inner-header__breadcrumbs breadcrumbs">
							<ul class="breadcrumbs__list">
								...
								<li class="breadcrumbs__item"><span class="breadcrumbs__current" title="ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ">Контакты</span></li>
							</ul>
						</nav>
						<h1 class="inner-header__title">Контакты</h1>
					</div>
				</header>
									...
									<div class="block-13">
										<dl class="block-13__list block-13-list">
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Электронная почта</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>mailto:support@{{domain}}">поддержка@ {{домен}}</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Телефон</dt>
												<dd class="block-13-list__value"><a href="<?=$language_suffix?>+447537131289">+44 753 713 12 89</a></dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Адрес</dt>
												<dd class="block-13-list__value">175 Пикадилли, Сент-Джеймс, Лондон W1J 9TB</dd>
											</div>
											<div class="block-13-list__item">
												<dt class="block-13-list__property h3">Подписывайтесь на нас</dt>
												<dd class="block-13-list__value">
													<ul class="block-13-list__links block-13-list-links">
														...
														<li class="block-13-list-links__item"><a class="block-13-list-links__link" href="<?=$language_suffix?>#">Телеграм</a></li>
													</ul>
												</dd>
											</div>
										</dl>
...
<img src="<?=$dir_prefix?>assets/img/deco/12.webp" alt="Деко">
									</figure>
								</div>
							</div>
						</div>
