...
<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							<h2 class="block-21__title">ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ</h2>
<button class="block-21__btn btn btn_d">Перейдите к разделу 
 
 
 
 
</button> </a> <a class="block-21__item" href="<?=$language_suffix?>contacts.php">							<h2 class="block-21__title">Контакты</h2>
<button class="block-21__btn btn btn_d">Перейдите в раздел</button> 
 </a> 
					</nav>
				</div>
			</section>
