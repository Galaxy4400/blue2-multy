						...
						<div class="menu" data-menu="main-menu">
							<nav class="menu__body" data-menu-container="main-menu" data-adapt="wrapper,1200">
								<ul class="menu__list">
									...
									<li class="menu__item" data-menu-item><a class="menu__link _active" href="<?=$language_suffix?>benefits.php">Voordelen</a></li>
		...
		<main class="page">
					...
					<div class="block-17__body">
						<div class="block-17__column block-17__column_content">
							<div class="block-17__content">
								<h2 class="block-17__title">Koop Portfolio Tracker</h2>
								<p class="block-17__text">Ontgrendelt snel de handel: meld u aan, stort en begin uw reis in slechts 5 minuten. Duik er nu in!</p>
							</div>
						</div>
						<div class="block-17__column block-17__column_actions">
							<div class="block-17__actions block-17-actions">
								<div class="block-17-actions__bottom">
									<a class="block-17-actions__btn btn btn_d btn_fw" href="<?=$language_suffix?>sign-up.php">Inschrijven</a>
								</div>
							...
							<figure class="block-17__image-2">
								<img src="<?=$dir_prefix?>assets/img/deco/8.webp" alt="beeld">
							</figure>
						</div>
						<figure class="block-17__image-1" data-adapt="block-17__column_actions,991">
							<img src="<?=$dir_prefix?>assets/img/deco/9.webp" alt="beeld">
						</figure>
					</div>
				</div>
			</section>
			...
			<section class="block-18">
				<div class="block-18__container _container">
					<h2 class="block-18__title">Hoe het werkt</h2>
					<div class="block-18__body">
						<div class="block-18__item">
							<h3 class="block-18__item-title">Een account aanmaken</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Je account herladen</h3>
						</div>
						<div class="block-18__item">
							<h3 class="block-18__item-title">Begin met kopen en verkopen</h3>
						</div>
					</div>
				</div>
			</section>
