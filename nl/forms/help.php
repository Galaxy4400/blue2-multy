		...
		<div class="block-22__body">
			<div class="block-22__column block-22__column_image">
				<div class="block-22__content">
					<h2 class="block-22__title">Hoe kunnen we helpen?</h2>
...
<label class="help-form__label" for="name">Naam</label> 
								</div>
...
<input class="help-form__input input" id="email" type="email" name="email" required>
						...
						<div class="help-form__row help-form__row_1">
							<div class="help-form__column">
								<div class="help-form__label-title">
<label class="help-form__label" for="message">Beschrijf het probleem</label> 
								</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Verzenden</button> 
						...
						<div class="help-form__row help-form__row_1">
							<p class="help-form__sub-text">Door hier uw persoonlijke gegevens in te voeren en op de knop te drukken, gaat u akkoord met het privacybeleid en de algemene voorwaarden van de website.</p>
						</div>
					</div>
				</form>
			</div>
