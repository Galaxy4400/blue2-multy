		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Meld je aan bij je account</h2>
...
<label class="help-form__label" for="email">Naam</label> 
								</div>
...
<a class="signin-form__link" href="<?=$language_suffix?>forgot.php">Wachtwoord vergeten?</a> 
								</div>
							</div>
						</div>
					</div>
					<div class="signin-form__section">
						<div class="signin-form__row signin-form__row_2">
							<div class="signin-form__column">
<button class="help-form__btn btn btn_d btn_fw" type="submit">Inloggen</button> 
								<p class="signin-form__sub-text">Geen account? <a class="signin-form__sub-link" href="<?=$language_suffix?>sign-up.php">Meld je aan.</a></p>
							</div>
