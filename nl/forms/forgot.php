		...
		<div class="block-25__body">
			<div class="block-25__column block-25__column_image">
				<div class="block-25__content">
					<h2 class="block-25__title">Wachtwoord vergeten</h2>
					<p class="block-25__text">Je hoeft je geen zorgen te maken! Voer hieronder je e-mailadres in en we sturen je een code voor het opnieuw instellen van je wachtwoord.</p>
				</div>
			</div>
...
<button class="help-form__btn btn btn_d btn_fw" type="submit">Verzenden</button> 
							</div>
