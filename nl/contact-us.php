				...
				<div class="block-21__container _container">
					<nav class="block-21__body">
						<a class="block-21__item" href="<?=$language_suffix?>faq.php">
							...
							<button class="block-21__btn btn btn_d">Ga verder naar de sectie
							...
							<h2 class="block-21__title">Contacten</h2>
							<button class="block-21__btn btn btn_d">Ga verder naar de sectie</button>
						</a>
					</nav>
				</div>
			</section>
